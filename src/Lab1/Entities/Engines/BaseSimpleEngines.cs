...
public abstract class BaseSimpleEngines
{
    private readonly double _fuelconsumptionrate;

    protected BaseSimpleEngines(double startFuel, double fuelConsumptionRate)
    {
    ...
    public virtual double CalculateFuelConsumption(double time) =>
        time * _fuelconsumptionrate;
}